    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return axios__WEBPACK_IMPORTED_MODULE_5___default.a.get(urlValue, reqOptions).data;

        case 5:
          responseValue = _context.sent;
          _context.next = 8;
          return axios__WEBPACK_IMPORTED_MODULE_5___default.a.get(urlNews).data;

        case 8:
          responseNews = _context.sent;
          return _context.abrupt("return", {
            bitcoinValue: responseValue.data.BTC.quote.USD,
            bitcoinNews: responseNews.articles
          });
...
//# sourceMappingURL=index.js.27d668503b521bb6e6d9.hot-update.js.map