...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var urlValue, urlNewa, reqOptions, response;
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          urlValue = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/latest?symbol=BTC";
          urlNewa = "https://newsapi.org/v2/everything?q=bitcoin&from=2019-07-16&sortBy=publishedAt&apiKey=323c894f6d7443dea2613c06482e22e3&language=en";
          reqOptions = {
            headers: {
          ...
          _context.next = 5;
          return axios__WEBPACK_IMPORTED_MODULE_5___default.a.get(urlValue, reqOptions);

        case 5:
          response = _context.sent;
          return _context.abrupt("return", {
            bitcoinValue: response.data.data.BTC.quote.USD
          });
...
//# sourceMappingURL=index.js.235d9e3b047a171eea0d.hot-update.js.map